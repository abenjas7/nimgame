...
The application provides an interactive board where the user selects adjacent sticks from one row, confirms moves, and can ask the computer to play. It communicates with the Flask backend hosted in the companion repository [`api_nim`](https://github.com/abenjas7/api_nim).
...
```text
https://github.com/abenjas7/api_nim
```
